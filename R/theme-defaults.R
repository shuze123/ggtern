...
theme_custom <- function(base_size             = 12,
  ...
  theme(
    ...
    tern.panel.grid.major   = element_line(linetype=6,size=1/2.134),
    tern.panel.grid.major.T = element_line(color = col.grid.T),
    tern.panel.grid.major.L = element_line(color = col.grid.L),
    tern.panel.grid.major.R = element_line(color = col.grid.R),
    tern.panel.grid.minor   = element_line(linetype=1,size=0.5/2.134,colour=col.grid.minor),
